...
int16_t SoP_int(int16_t x0,int16_t x1,int16_t x2,int16_t x3,int16_t x4,int16_t x5,int16_t x6,int16_t x7,int16_t x8)
{
	...
	//Computation of c1*x1 in register r32_0
	c = 22280;
	r32_0 = c*x1;

	//Computation of c3*x3 in register r32_1
	c = 22280;
	r32_1 = c*x3;
	...
	//Computation of c0*x0 in register r32_0
	c = 22280;
	r32_0 = c*x0;

	//Computation of c4*x4 in register r32_1
	c = 22280;
	r32_1 = c*x4;
	...
	//Computation of c2*x2 in register r32_1
	c = 16710;
	r32_1 = c*x2;
	...
	//Computation of c8*x8 in register r32_0
	c = -20887;
	r32_0 = c*x8;

	//Computation of c7*x7 in register r32_1
	c = 26781;
	r32_1 = c*x7;
	...
	//Computation of c5*x5 in register r32_0
	c = 23520;
	r32_0 = c*x5;
	...
	//Computation of c6*x6 in register r32_0
	c = -26282;
	r32_0 = c*x6;
...
/* double SoP_ac_fixed(float tab[int16_t x0,int16_t x1,int16_t x2,int16_t x3,int16_t x4,int16_t x5,int16_t x6,int16_t x7,int16_t x8])
{
	...
	ac_fixed<32,9,true,AC_TRN> r12 = c5*x5;
	...
	ac_fixed<32,9,true,AC_TRN> r14 = c6*x6;


	//Computation of r13+r14 in register r15
	ac_fixed<32,5,true,AC_TRN> r15 = r13 + r14;

	//Computation of r8+r15 in register r16
	ac_fixed<32,5,true,AC_TRN> r16 = r8 + r15;
