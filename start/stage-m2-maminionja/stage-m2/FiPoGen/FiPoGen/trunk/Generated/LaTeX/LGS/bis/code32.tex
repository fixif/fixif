...
child{[sibling distance=3.000000cm]
	node(DAdd_3901494) [form] {$F$}
	child{
		node(Add_3901494) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt172k1 lsb  8_M) [decM] {$\gg 22 $}
		child{[level distance=0.4cm]
			node(Multt172k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {1026962}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultu1k lsb  8_M) [decM] {$\gg 9 $}
		child{[level distance=0.4cm]
