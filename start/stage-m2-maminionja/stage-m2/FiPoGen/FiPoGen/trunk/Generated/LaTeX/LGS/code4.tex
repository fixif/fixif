...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt27k1 lsb  10_M) [decM] {$\gg 20 $}
		child{[level distance=0.4cm]
			node(Multt27k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst0) [cst] {802559}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt28k1 lsb  10_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt28k1 lsb  10) [mult] {$\times$}
			child{
