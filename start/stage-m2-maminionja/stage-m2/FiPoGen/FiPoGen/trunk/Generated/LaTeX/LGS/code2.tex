...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt10k1 lsb  10_M) [decM] {$\gg 20 $}
		child{[level distance=0.4cm]
			node(Multt10k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst0) [cst] {1051784}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt11k1 lsb  10_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt11k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-4194304}
