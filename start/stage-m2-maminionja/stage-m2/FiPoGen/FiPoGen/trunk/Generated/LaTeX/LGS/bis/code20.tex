...
child{[sibling distance=3.000000cm]
	node(DAdd_3901464) [form] {$F$}
	child{
		node(Add_3901464) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt153k1 lsb  10_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt153k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst0) [cst] {-8388608}
			edge from parent node[left] {(0,-23)}
			}
			child{
				node(Var0) [var] {$t153[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt154k1 lsb  10_M) [decM] {$\gg 19 $}
		child{[level distance=0.4cm]
			node(Multt154k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-180225}
			edge from parent node[left] {(-3,-21)}
			}
			child{
				node(Var1) [var] {$t154[k+1]$}
