...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm]
			node(DMultt166k1 lsb  20) [form] {$F$}
			child{[level distance=0.4cm]
				node(Multt166k1 lsb  20) [mult] {$\times$}
				child{
					node(Cst1) [cst] {-32768}
				...
				edge from parent node[left] {(11,-20)}
			}
			edge from parent node[left,sloped,above] {(10,-21)}
		}
		child{[sibling distance=1cm]
			node(DMultt167k1 lsb  20) [form] {$F$}
			child{[level distance=0.4cm]
				node(Multt167k1 lsb  20) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-18572}
	...
	child{[sibling distance=1cm]
		node(DMultt165k1 lsb  20) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt165k1 lsb  20) [mult] {$\times$}
			child{
				node(Cst0) [cst] {21261}
			edge from parent node[left] {(0,-15)}
			}
