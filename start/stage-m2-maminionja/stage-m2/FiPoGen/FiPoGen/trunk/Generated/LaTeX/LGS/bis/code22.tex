...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt163k1 lsb  9_M) [decM] {$\gg 5 $}
			child{[level distance=0.4cm]
				node(Multt163k1 lsb  9) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-363702}
				edge from parent node[left] {(-1,-20)}
				}
				child{
					node(Var2) [var] {$t163[k+1]$}
				edge from parent node[right] {(10,6)}
				}
			}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt161k1 lsb  9_M) [decM] {$\gg 21 $}
		child{[level distance=0.4cm]
			node(Multt161k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {180225}
			edge from parent node[left] {(-3,-21)}
			}
			child{
				node(Var0) [var] {$t161[k+1]$}
