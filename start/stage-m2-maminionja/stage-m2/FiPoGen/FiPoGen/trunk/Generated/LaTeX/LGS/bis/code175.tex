...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm]
		node(DMultt167k1 lsb  19) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt167k1 lsb  19) [mult] {$\times$}
			child{
				node(Cst0) [cst] {23644}
			...
			edge from parent node[left] {(12,-19)}
		}
		edge from parent node[left,sloped,above] {(10,-21)}
	}
	child{[sibling distance=1cm]
		node(DMultt168k1 lsb  19) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt168k1 lsb  19) [mult] {$\times$}
			child{
				node(Cst1) [cst] {17243}
