...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt146k1 lsb  11_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt146k1 lsb  11) [mult] {$\times$}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt147k1 lsb  11_M) [decM] {$\gg 21 $}
		child{[level distance=0.4cm]
			node(Multt147k1 lsb  11) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-1749432}
