...
child{[sibling distance=3.000000cm]
	node(DAdd_3901454) [form] {$F$}
	child{
		node(Add_3901454) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt44k1 lsb  8_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt44k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {253723}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt45k1 lsb  8_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt45k1 lsb  8) [mult] {$\times$}
			child{
