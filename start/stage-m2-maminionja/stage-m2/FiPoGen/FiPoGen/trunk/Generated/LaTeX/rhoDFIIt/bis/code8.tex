...
child{[sibling distance=5.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt2k1 lsb  8_M) [decM] {$\gg 17 $}
			child{[level distance=0.4cm]
				node(Multt2k1 lsb  8) [mult] {$\times$}
				child{
					node(Cst1) [cst] {524288}
				edge from parent node[left] {(1,-19)}
				}
				child{
					node(Var1) [var] {$t2[k+1]$}
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultx1k lsb  8_M) [decM] {$\gg 18 $}
			child{[level distance=0.4cm]
				node(Multx1k lsb  8) [mult] {$\times$}
				child{
					node(Cst2) [cst] {261823}
