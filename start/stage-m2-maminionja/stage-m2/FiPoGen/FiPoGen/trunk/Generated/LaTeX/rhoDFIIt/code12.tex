...
child{[sibling distance=5.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultx5k lsb  9_M) [decM] {$\gg 18 $}
			child{[level distance=0.4cm]
	...
	child{[sibling distance=3.000000cm]
		node(Add_76) [adder] {$+$}
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt1k1 lsb  9_M) [decM] {$\gg 20 $}
			child{[level distance=0.4cm]
				node(Multt1k1 lsb  9) [mult] {$\times$}
				child{
					node(Cst0) [cst] {1229970}
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt6k1 lsb  9_M) [decM] {$\gg 17 $}
			child{[level distance=0.4cm]
				node(Multt6k1 lsb  9) [mult] {$\times$}
				child{
					node(Cst3) [cst] {524288}
				edge from parent node[left] {(1,-19)}
				}
				child{
					node(Var3) [var] {$t6[k+1]$}
