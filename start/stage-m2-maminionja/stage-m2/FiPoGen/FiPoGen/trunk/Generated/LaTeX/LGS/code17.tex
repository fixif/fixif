...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt132k1 lsb  10_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt132k1 lsb  10) [mult] {$\times$}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt133k1 lsb  10_M) [decM] {$\gg 19 $}
		child{[level distance=0.4cm]
			node(Multt133k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-734391}
