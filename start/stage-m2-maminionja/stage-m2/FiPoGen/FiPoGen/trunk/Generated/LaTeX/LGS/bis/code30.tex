...
child{[sibling distance=3.000000cm]
	node(DAdd_3901492) [form] {$F$}
	child{
		node(Add_3901492) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt170k1 lsb  8_M) [decM] {$\gg 25 $}
		child{[level distance=0.4cm]
			node(Multt170k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {1046958}
			edge from parent node[left] {(-6,-26)}
			}
			child{
				node(Var0) [var] {$t170[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultu1k lsb  8_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multu1k lsb  8) [mult] {$\times$}
			child{
				node(Cst1) [cst] {1024}
			edge from parent node[left] {(1,-10)}
			}
			child{
				node(Var1) [var] {$u1[k]$}
