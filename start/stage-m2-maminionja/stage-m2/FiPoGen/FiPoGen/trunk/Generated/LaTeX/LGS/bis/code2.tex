...
child{[sibling distance=3.000000cm]
	node(DAdd_3901452) [form] {$F$}
	child{
		node(Add_3901452) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt10k1 lsb  8_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt10k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {181851}
			edge from parent node[left] {(-1,-19)}
			}
			child{
				node(Var0) [var] {$t10[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt11k1 lsb  8_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt11k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-1048576}
			edge from parent node[left] {(0,-20)}
			}
			child{
				node(Var1) [var] {$t11[k+1]$}
