...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt163k1 lsb  11_M) [decM] {$\gg 6 $}
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt164k1 lsb  11_M) [decM] {$\gg 5 $}
			child{[level distance=0.4cm]
				node(Multt164k1 lsb  11) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-1605117}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt162k1 lsb  11_M) [decM] {$\gg 5 $}
		child{[level distance=0.4cm]
			node(Multt162k1 lsb  11) [mult] {$\times$}
			child{
				node(Cst0) [cst] {2103568}
