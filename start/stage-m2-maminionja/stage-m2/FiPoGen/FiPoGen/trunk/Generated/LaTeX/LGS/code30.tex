...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt170k1 lsb  10_M) [decM] {$\gg 25 $}
		child{[level distance=0.4cm]
			node(Multt170k1 lsb  10) [mult] {$\times$}
			child{
				node(Cst0) [cst] {2770758}
			edge from parent node[left] {(-4,-26)}
			}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultu1k lsb  10_M) [decM] {$\gg 12 $}
		child{[level distance=0.4cm]
