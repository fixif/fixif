...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm]
			node(Multt163k1 lsb  21) [mult] {$\times$}
			child{
				node(Cst2) [cst] {-22731}
		...
		child{[sibling distance=1cm]
			node(DMultt162k1 lsb  20) [form] {$F$}
			child{[level distance=0.4cm]
				node(Multt162k1 lsb  20) [mult] {$\times$}
				child{
					node(Cst1) [cst] {-32768}
	...
	child{[sibling distance=1cm]
		node(DMultt161k1 lsb  22) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt161k1 lsb  22) [mult] {$\times$}
			child{
				node(Cst0) [cst] {22528}
