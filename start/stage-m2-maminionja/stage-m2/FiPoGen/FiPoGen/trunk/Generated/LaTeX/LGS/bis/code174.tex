...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm]
			node(DMultt168k1 lsb  20) [form] {$F$}
			child{[level distance=0.4cm]
				node(Multt168k1 lsb  20) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-23644}
		...
		child{[sibling distance=1cm]
			node(DMultt166k1 lsb  19) [form] {$F$}
			child{[level distance=0.4cm]
				node(Multt166k1 lsb  19) [mult] {$\times$}
				child{
					node(Cst0) [cst] {18572}
	...
	child{[sibling distance=1cm]
		node(Multt167k1 lsb  21) [mult] {$\times$}
		child{
			node(Cst1) [cst] {-32768}
