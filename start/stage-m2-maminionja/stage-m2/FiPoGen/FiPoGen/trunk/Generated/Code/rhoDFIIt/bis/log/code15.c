...
double SoP_float(double v0,double v1,double v2)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.388702392578125 * v2 + 0.13220977783203125 * v0 + 0.786346435546875 * v1;
	return r; 
}
...
ac_fixed<16,12,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v2,ac_fixed<16,12,true,AC_TRN> v0,ac_fixed<16,12,true,AC_TRN> v1)
{
	...
	ac_fixed<16,0,true,AC_TRN> c2 = -0.388702392578125;
	ac_fixed<32,9,true,AC_TRN> r0 = c2*v2;

	//Computation of c0*v0 in register r1
	ac_fixed<16,-1,true,AC_TRN> c0 = 0.13220977783203125;
	...
	ac_fixed<16,1,true,AC_TRN> c1 = 0.786346435546875;
