...
double SoP_float(double v0,double v1)
{
    /*      TP_Float_sop        */
    double r;
    r = -1 * v0 + -0.944675445556640625 * v1;
	return r; 
}
...
ac_fixed<20,10,true> SoP_ac_fixed(ac_fixed<5,11,true,AC_TRN> v0,ac_fixed<20,10,true,AC_TRN> v1)
{
	...
	ac_fixed<22,1,true,AC_TRN> c1 = -0.944675445556640625;
	sd = sd + c1*v1;
