...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.75898647308349609375 * v0 + 0.35226154327392578125 * v1 + 0.061712741851806640625 * v2 + 0.3872280120849609375 * v3 + 0.59441089630126953125 * v4 + 0.87076663970947265625 * v5 + -0.344676971435546875 * v6 + 0.52236270904541015625 * v7 + -0.731526851654052734375 * v8;
	return r; 
}
...
ac_fixed<19,11,true> SoP_ac_fixed(ac_fixed<20,10,true,AC_TRN> v0,ac_fixed<20,11,true,AC_TRN> v1,ac_fixed<17,10,true,AC_TRN> v2,ac_fixed<19,10,true,AC_TRN> v3,ac_fixed<18,9,true,AC_TRN> v4,ac_fixed<19,10,true,AC_TRN> v5,ac_fixed<19,10,true,AC_TRN> v6,ac_fixed<19,11,true,AC_TRN> v7,ac_fixed<17,9,true,AC_TRN> v8)
{
