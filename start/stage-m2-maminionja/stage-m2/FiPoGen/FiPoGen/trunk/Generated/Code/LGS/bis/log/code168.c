...
ac_fixed<16,12,true> SoP_ac_fixed(ac_fixed<16,11,true,AC_TRN> v1,ac_fixed<16,12,true,AC_TRN> v0)
{
	...
	ac_fixed<16,-2,true,AC_TRN> c1 = -0.0859375;
	ac_fixed<32,9,true,AC_TRN> r0 = c1*v1;
