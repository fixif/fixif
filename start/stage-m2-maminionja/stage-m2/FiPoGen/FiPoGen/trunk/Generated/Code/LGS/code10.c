...
double SoP_float(double v0,double v1)
{
    /*      TP_Float_sop        */
    double r;
    r = 2.059520721435546875 * v0 + -1 * v1;
	return r; 
}
...
ac_fixed<19,12,true> SoP_ac_fixed(ac_fixed<21,11,true,AC_TRN> v0,ac_fixed<5,11,true,AC_TRN> v1)
{
	...
	ac_fixed<22,3,true,AC_TRN> c0 = 2.059520721435546875;
	sd = sd + c0*v0;
