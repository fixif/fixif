...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.06196117401123046875 * v3 + -0.0005931854248046875 * v4 + -0.1602115631103515625 * v1 + -0.000762939453125 * v6 + -0.01969623565673828125 * v2 + 0.00795745849609375 * v5 + 0.9543926715850830078125 * v0 + -0.4258556365966796875 * v8;
	return r; 
}
...
ac_fixed<19,13,true> SoP_ac_fixed(ac_fixed<13,10,true,AC_TRN> v3,ac_fixed<12,9,true,AC_TRN> v4,ac_fixed<13,10,true,AC_TRN> v1,ac_fixed<5,6,true,AC_TRN> v6,ac_fixed<16,11,true,AC_TRN> v2,ac_fixed<11,9,true,AC_TRN> v5,ac_fixed<19,13,true,AC_TRN> v0,ac_fixed<15,9,true,AC_TRN> v8)
{
