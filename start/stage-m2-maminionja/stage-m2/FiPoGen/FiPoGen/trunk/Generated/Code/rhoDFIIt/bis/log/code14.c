...
double SoP_float(double v0,double v1,double v2,double v3)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.481689453125 * v3 + 0.192962646484375 * v2 + 0.13416290283203125 * v0 + 1 * v1;
	return r; 
}
...
ac_fixed<16,12,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v3,ac_fixed<16,12,true,AC_TRN> v2,ac_fixed<16,12,true,AC_TRN> v0,ac_fixed<16,11,true,AC_TRN> v1)
{
	...
	ac_fixed<16,0,true,AC_TRN> c3 = -0.481689453125;
	ac_fixed<32,9,true,AC_TRN> r0 = c3*v3;

	//Computation of c2*v2 in register r1
	ac_fixed<16,-1,true,AC_TRN> c2 = 0.192962646484375;
	...
	ac_fixed<16,-1,true,AC_TRN> c0 = 0.13416290283203125;
