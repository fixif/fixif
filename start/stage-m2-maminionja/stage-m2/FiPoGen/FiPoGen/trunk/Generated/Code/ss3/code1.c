...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.447527408599853515625 * v0 + 0.26905536651611328125 * v1 + 0.03685092926025390625 * v2 + 0.2293169498443603515625 * v3 + 0.463319301605224609375 * v4 + 0.0707118511199951171875 * v5 + -0.3539412021636962890625 * v6 + 0.0723285675048828125 * v7 + 0.432636260986328125 * v8;
	return r; 
}
