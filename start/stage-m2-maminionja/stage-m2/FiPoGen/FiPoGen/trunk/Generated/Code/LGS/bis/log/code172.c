...
double SoP_float(double v0,double v1,double v2)
{
    /*      TP_Float_sop        */
    double r;
    r = -1 * v1 + -0.648834228515625 * v2 + 0.4839324951171875 * v0;
	return r; 
}
...
ac_fixed<16,11,true> SoP_ac_fixed(ac_fixed<16,11,true,AC_TRN> v1,ac_fixed<16,11,true,AC_TRN> v2,ac_fixed<16,11,true,AC_TRN> v0)
{
	...
	ac_fixed<32,12,true,AC_TRN> r0 = c1*v1;

	//Computation of c2*v2 in register r1
	ac_fixed<16,1,true,AC_TRN> c2 = -0.648834228515625;
	...
	ac_fixed<16,0,true,AC_TRN> c0 = 0.4839324951171875;
