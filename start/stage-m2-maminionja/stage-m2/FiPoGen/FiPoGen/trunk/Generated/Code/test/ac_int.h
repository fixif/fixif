...
#pragma builtin
  ...
  template<> inline bool iv_equal_zero<0>(const int *op) { (void) op; return true; }
  ...
  template<> inline bool iv_equal_ones<0>(const int *op) { (void) op; return true; }
  ...
  template<> inline void iv_extend<-2>(int *r, int ext) { (void) r; (void) ext; }
  template<> inline void iv_extend<-1>(int *r, int ext) { (void) r; (void) ext; }
  template<> inline void iv_extend<0>(int *r, int ext) { (void) r; (void) ext; }
  ...
  template<> inline bool iv_uadd_carry<0>(const int *op1, bool carry, int *r) { (void) op1; (void) r; return carry; }
  ...
  template<> inline bool iv_add_int_carry<0>(const int *op1, int op2, bool carry, int *r) { (void) op1; (void) op2; (void) r; return carry; }
  ...
  template<> inline bool iv_uadd_n<0>(const int *op1, const int *op2, int *r) { (void) op1; (void) op2; (void) r; return false; }
  ...
  template<> inline bool iv_sub_int_borrow<0>(const int *op1, int op2, bool borrow, int *r) { (void) op1; (void) op2; (void) r; return borrow; }
  ...
  template<> inline bool iv_sub_int_borrow<0>(int op1, const int *op2, bool borrow, int *r) { (void) op1, (void) op2; (void) r; return borrow; }
  ...
  template<> inline bool iv_all_bits_same<0>(const int *op, bool bit) { (void) op; (void) bit; return true; }
  ...
  inline void iv_const_shift_l(const int *op1, int *r) {
    ...
    if(!B) {
      ...
      if(s31) {
        iv_extend<AC_MIN(ishift,Nr)>(r, 0);
        unsigned lw = 0;
