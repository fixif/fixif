...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.0986328125 * v5 + -0.201171875 * v6 + -0.000762939453125 * v0 + 0.0137939453125 * v3 + -0.0009765625 * v8 + -0.035888671875 * v4 + -0.30859375 * v7 + -0.00299072265625 * v2 + -0.004638671875 * v1;
	return r; 
}
...
ac_fixed<5,6,true> SoP_ac_fixed(ac_fixed<11,9,true,AC_TRN> v5,ac_fixed<5,6,true,AC_TRN> v6,ac_fixed<19,13,true,AC_TRN> v0,ac_fixed<13,10,true,AC_TRN> v3,ac_fixed<15,9,true,AC_TRN> v8,ac_fixed<12,9,true,AC_TRN> v4,ac_fixed<3,5,true,AC_TRN> v7,ac_fixed<16,11,true,AC_TRN> v2,ac_fixed<13,10,true,AC_TRN> v1)
{
