...
double SoP_float(double v0,double v1,double v2,double v3)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.764850616455078125 * v1 + -0.035347461700439453125 * v2 + -0.063218891620635986328125 * v0 + 1 * v3;
	return r; 
}
...
/* double SoP_ac_fixed(float tab[int16_t v0,int16_t v1,int16_t v2,int16_t v3])
{
	...
	float L3 = tab[3]*pow(2,-8);

    
          TP_Float        

	//Computation of c1*v1 in register r0
	ac_fixed<20,1,true,AC_TRN> c1 = -0.764850616455078125;
	ac_fixed<18,9,true,AC_TRN> v1 = L1;
	ac_fixed<19,9,true,AC_TRN> r0 = c1*v1;


	//Computation of c2*v2 in register r1
	ac_fixed<18,-3,true,AC_TRN> c2 = -0.035347461700439453125;
	ac_fixed<19,11,true,AC_TRN> v2 = L2;
	ac_fixed<16,6,true,AC_TRN> r1 = c2*v2;


	//Computation of r0+r1 in register r2
	ac_fixed<19,9,true,AC_TRN> r2 = r0 + r1;

	//Computation of c0*v0 in register r3
	ac_fixed<22,-2,true,AC_TRN> c0 = -0.063218891620635986328125;
	ac_fixed<20,14,true,AC_TRN> v0 = L0;
	ac_fixed<20,10,true,AC_TRN> r3 = c0*v0;


	//Computation of c3*v3 in register r4
	ac_fixed<22,2,true,AC_TRN> c3 = 1;
	ac_fixed<18,10,true,AC_TRN> v3 = L3;
	ac_fixed<20,10,true,AC_TRN> r4 = c3*v3;
	...
	ac_fixed<20,10,true,AC_TRN> r6 = r2 + r5;
