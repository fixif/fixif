...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.06334221363067626953125 * v0 + 0.613640308380126953125 * v1 + 0.9157526493072509765625 * v2 + 0.40147411823272705078125 * v3 + -0.0357959270477294921875 * v4 + 0.67137813568115234375 * v5 + 0.3578937053680419921875 * v6 + 0.133155643939971923828125 * v7 + 0.010509490966796875 * v8;
	return r; 
}
...
ac_fixed<18,9,true> SoP_ac_fixed(ac_fixed<19,10,true,AC_TRN> v0,ac_fixed<20,11,true,AC_TRN> v1,ac_fixed<17,10,true,AC_TRN> v2,ac_fixed<19,10,true,AC_TRN> v3,ac_fixed<18,9,true,AC_TRN> v4,ac_fixed<19,10,true,AC_TRN> v5,ac_fixed<18,9,true,AC_TRN> v6,ac_fixed<20,11,true,AC_TRN> v7,ac_fixed<17,9,true,AC_TRN> v8)
{
