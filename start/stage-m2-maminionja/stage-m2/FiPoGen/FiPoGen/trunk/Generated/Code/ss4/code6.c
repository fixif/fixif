...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.15016651153564453125 * v0 + -0.0540292263031005859375 * v1 + -0.07587969303131103515625 * v2 + -0.4501855373382568359375 * v3 + 0.0629055500030517578125 * v4 + 0.08938658237457275390625 * v5 + 0.11448574066162109375 * v6 + -0.12313306331634521484375 * v7 + 0.11638641357421875 * v8;
	return r; 
}
