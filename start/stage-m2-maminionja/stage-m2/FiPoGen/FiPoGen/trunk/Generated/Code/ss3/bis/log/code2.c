...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.0582332611083984375 * v8 + 0.0377597808837890625 * v7 + 0.2238616943359375 * v6 + 0.0713043212890625 * v5 + -0.3608856201171875 * v4 + 0.4417572021484375 * v3 + -0.2625274658203125 * v2 + -0.3134307861328125 * v1 + -0.2237548828125 * v0;
	return r; 
}
...
ac_fixed<16,9,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v8,ac_fixed<16,10,true,AC_TRN> v7,ac_fixed<16,11,true,AC_TRN> v6,ac_fixed<16,11,true,AC_TRN> v5,ac_fixed<16,9,true,AC_TRN> v4,ac_fixed<16,9,true,AC_TRN> v3,ac_fixed<16,9,true,AC_TRN> v2,ac_fixed<16,9,true,AC_TRN> v1,ac_fixed<16,10,true,AC_TRN> v0)
{
	...
	ac_fixed<16,-3,true,AC_TRN> c8 = -0.0582332611083984375;
	ac_fixed<32,6,true,AC_TRN> r0 = c8*v8;

	//Computation of c7*v7 in register r1
	ac_fixed<16,-3,true,AC_TRN> c7 = 0.0377597808837890625;
	...
	ac_fixed<16,-1,true,AC_TRN> c6 = 0.2238616943359375;
	ac_fixed<32,10,true,AC_TRN> r3 = c6*v6;


	//Computation of r2+r3 in register r4
	ac_fixed<32,9,true,AC_TRN> r4 = r2 + r3;
	//Computation of c5*v5 in register r5
	ac_fixed<16,-2,true,AC_TRN> c5 = 0.0713043212890625;
	ac_fixed<32,9,true,AC_TRN> r5 = c5*v5;


	//Computation of r4+r5 in register r6
	ac_fixed<32,9,true,AC_TRN> r6 = r4 + r5;
	//Computation of c4*v4 in register r7
	ac_fixed<16,0,true,AC_TRN> c4 = -0.3608856201171875;
	...
	ac_fixed<16,0,true,AC_TRN> c3 = 0.4417572021484375;
	...
	ac_fixed<16,0,true,AC_TRN> c2 = -0.2625274658203125;
	ac_fixed<32,9,true,AC_TRN> r11 = c2*v2;


	//Computation of r10+r11 in register r12
	ac_fixed<32,9,true,AC_TRN> r12 = r10 + r11;
	//Computation of c1*v1 in register r13
	ac_fixed<16,0,true,AC_TRN> c1 = -0.3134307861328125;
	...
	ac_fixed<16,-1,true,AC_TRN> c0 = -0.2237548828125;
