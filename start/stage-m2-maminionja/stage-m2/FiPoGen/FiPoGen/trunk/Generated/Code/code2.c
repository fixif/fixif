...
double SoP_float(double v0,double v1,double v2,double v3)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.009027957916259765625 * v3 + 407.546875 * v0 + 951 * v1 + 679.03125 * v2;
	return r; 
}
...
/* double SoP_ac_fixed(float tab[int16_t v0,int16_t v1,int16_t v2,int16_t v3])
{
	...
	ac_fixed<16,11,true,AC_TRN> c1 = 951;
	...
	ac_fixed<16,11,true,AC_TRN> c2 = 679.03125;
	ac_fixed<16,7,true,AC_TRN> v2 = L2;
	ac_fixed<32,18,true,AC_TRN> r5 = c2*v2;
