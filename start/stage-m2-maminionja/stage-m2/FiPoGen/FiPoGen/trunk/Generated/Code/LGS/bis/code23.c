...
double SoP_float(double v0,double v1,double v2)
{
    /*      TP_Float_sop        */
    double r;
    r = -1 * v1 + -0.41431427001953125 * v2 + 0.3468532562255859375 * v0;
	return r; 
}
...
ac_fixed<18,11,true> SoP_ac_fixed(ac_fixed<5,11,true,AC_TRN> v1,ac_fixed<5,11,true,AC_TRN> v2,ac_fixed<5,11,true,AC_TRN> v0)
{
	...
	ac_fixed<20,0,true,AC_TRN> c2 = -0.41431427001953125;
	sd = sd + c2*v2;
	//Computation of c0*v0 in sd
	ac_fixed<20,0,true,AC_TRN> c0 = 0.3468532562255859375;
	sd = sd + c0*v0;
