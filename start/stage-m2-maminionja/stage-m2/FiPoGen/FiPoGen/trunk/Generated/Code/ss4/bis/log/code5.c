...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.041904449462890625 * v8 + 1.2332763671875 * v7 + 1.26446533203125 * v5 + 1.96728515625 * v3 + 0.67840576171875 * v2 + 2.3868408203125 * v1 + 1.56597900390625 * v0 + 1.0870361328125 * v6 + 0.45611572265625 * v4;
	return r; 
}
...
ac_fixed<16,9,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v8,ac_fixed<16,9,true,AC_TRN> v7,ac_fixed<16,9,true,AC_TRN> v5,ac_fixed<16,9,true,AC_TRN> v3,ac_fixed<16,10,true,AC_TRN> v2,ac_fixed<16,8,true,AC_TRN> v1,ac_fixed<16,9,true,AC_TRN> v0,ac_fixed<16,8,true,AC_TRN> v6,ac_fixed<16,10,true,AC_TRN> v4)
{
	...
	ac_fixed<16,-3,true,AC_TRN> c8 = 0.041904449462890625;
	ac_fixed<32,6,true,AC_TRN> r0 = c8*v8;

	//Computation of c7*v7 in register r1
	ac_fixed<16,2,true,AC_TRN> c7 = 1.2332763671875;
	...
	ac_fixed<16,2,true,AC_TRN> c5 = 1.26446533203125;
	...
	ac_fixed<16,2,true,AC_TRN> c3 = 1.96728515625;
	...
	ac_fixed<16,0,true,AC_TRN> c4 = 0.45611572265625;
