...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.2373199462890625 * v3 + -0.0030059814453125 * v4 + -0.5785961151123046875 * v1 + 0.00299072265625 * v6 + 0.67735195159912109375 * v2 + -0.025295257568359375 * v5 + 0.0196964740753173828125 * v0 + 0.3561248779296875 * v8;
	return r; 
}
...
ac_fixed<16,11,true> SoP_ac_fixed(ac_fixed<13,10,true,AC_TRN> v3,ac_fixed<12,9,true,AC_TRN> v4,ac_fixed<13,10,true,AC_TRN> v1,ac_fixed<5,6,true,AC_TRN> v6,ac_fixed<16,11,true,AC_TRN> v2,ac_fixed<11,9,true,AC_TRN> v5,ac_fixed<19,13,true,AC_TRN> v0,ac_fixed<15,9,true,AC_TRN> v8)
{
