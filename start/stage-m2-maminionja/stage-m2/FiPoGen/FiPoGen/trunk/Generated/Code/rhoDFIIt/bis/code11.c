...
double SoP_float(double v0,double v1,double v2,double v3)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.069734096527099609375 * v1 + 0.20178127288818359375 * v2 + 0.2574462890625 * v0 + 1 * v3;
	return r; 
}
...
ac_fixed<18,12,true> SoP_ac_fixed(ac_fixed<17,11,true,AC_TRN> v1,ac_fixed<18,12,true,AC_TRN> v2,ac_fixed<17,12,true,AC_TRN> v0,ac_fixed<16,9,true,AC_TRN> v3)
{
	...
	ac_fixed<21,-2,true,AC_TRN> c1 = -0.069734096527099609375;
	sd = sd + c1*v1;
	//Computation of c2*v2 in sd
	ac_fixed<19,-1,true,AC_TRN> c2 = 0.20178127288818359375;
	sd = sd + c2*v2;
	//Computation of c0*v0 in sd
	ac_fixed<20,0,true,AC_TRN> c0 = 0.2574462890625;
	sd = sd + c0*v0;
