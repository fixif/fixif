...
from fipogen.SIF.algorithmAuxFunc import _scalprodCdouble
from numpy import tril, all, r_, c_


# define which method to add to the SIF
__all__ = ["algorithmCfloat"]


def algorithmCfloat(R, funcName, fileName=None):

	env = Environment(loader=PackageLoader('SIF','templates'), trim_blocks=True, lstrip_blocks=True )
