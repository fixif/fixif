...
class Test_Constants(unittest.TestCase):
	...
	def test_construct(self):
		...
		self.assertEqual(c.mantissa, 254)

		c = Constant( value=127, wl=8)
		self.assertEqual( c.FPF.wml(), (8,7,0) )
		self.assertEqual(c.mantissa, 127)
		...
		self.assertEqual(c.mantissa, 94)
		...
		self.assertEqual( c.FPF.wml(), (8,7,0) )
		self.assertEqual(c.mantissa, 128)
		...
		self.assertEqual(c.mantissa, 64)
		...
		self.assertEqual( c.FPF.wml(), (8,7,0) )
		self.assertEqual(c.mantissa, -65)
