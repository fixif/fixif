...
double SoP_float(int16_t x0,int16_t x1,int16_t x2,int16_t x3)
{
    /*      TP_Float_sop        */
    double r;
    ((-0.0048568248748779296875 * x2*pow(2,-9) + 1 * x3*pow(2,-11)) + (-0.761993408203125 * x0*pow(2,-11) + -0.25421142578125 * x1*pow(2,-11)))
...
/* double SoP_ac_fixed(float tab[int16_t x0,int16_t x1,int16_t x2,int16_t x3])
{
	...
	//Computation of c2*x2 in register r0
	ac_fixed<16,-6,true,AC_TRN> c2 = -0.0048568248748779296875;
	ac_fixed<16,7,true,AC_TRN> x2 = L2;
	ac_fixed<32,1,true,AC_TRN> r0 = c2*x2;
	...
	ac_fixed<32,5,true,AC_TRN> r6 = r2 + r5;

	//Computation of the final right shift
	ac_fixed<16,5,true,AC_TRN> r7 = r6;
