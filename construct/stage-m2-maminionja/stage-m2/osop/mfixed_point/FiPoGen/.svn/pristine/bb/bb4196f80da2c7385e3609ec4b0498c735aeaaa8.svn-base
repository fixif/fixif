...
double SoP_float(int16_t x0,int16_t x1,int16_t x2,int16_t x3)
{
    /*      TP_Float_sop        */
    double r;
    ((0.04692840576171875 * x2*pow(2,-9) + 1 * x3*pow(2,-11)) + (0.3881378173828125 * x0*pow(2,-10) + 0.5428466796875 * x1*pow(2,-11)))
...
/* double SoP_ac_fixed(float tab[int16_t x0,int16_t x1,int16_t x2,int16_t x3])
{
	...
	//Computation of c2*x2 in register r0
	ac_fixed<16,-3,true,AC_TRN> c2 = 0.04692840576171875;
	ac_fixed<16,7,true,AC_TRN> x2 = L2;
	ac_fixed<32,4,true,AC_TRN> r0 = c2*x2;


	//Computation of c3*x3 in register r1
	ac_fixed<16,2,true,AC_TRN> c3 = 1;
	ac_fixed<16,5,true,AC_TRN> x3 = L3;
	ac_fixed<32,7,true,AC_TRN> r1 = c3*x3;
	...
	ac_fixed<16,0,true,AC_TRN> c0 = 0.3881378173828125;
	ac_fixed<16,6,true,AC_TRN> x0 = L0;
	ac_fixed<32,6,true,AC_TRN> r3 = c0*x0;


	//Computation of c1*x1 in register r4
	ac_fixed<16,1,true,AC_TRN> c1 = 0.5428466796875;
	ac_fixed<16,5,true,AC_TRN> x1 = L1;
	ac_fixed<32,6,true,AC_TRN> r4 = c1*x1;
	...
	ac_fixed<32,6,true,AC_TRN> r6 = r2 + r5;
