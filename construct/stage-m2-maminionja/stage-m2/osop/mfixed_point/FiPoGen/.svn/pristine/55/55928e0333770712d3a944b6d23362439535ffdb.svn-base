...
/* double SoP_ac_fixed(float tab[int16_t x0,int16_t x1,int16_t x2,int16_t x3,int16_t x4,int16_t x5,int16_t x6,int16_t x7,int16_t x8])
{
	...
	//Computation of r0+r1 in register r2
	ac_fixed<21,5,true,AC_TRN> r2 = r0 + r1;
	...
	ac_fixed<21,5,true,AC_TRN> r4 = r2 + r3;
	...
	ac_fixed<21,5,true,AC_TRN> r7 = r5 + r6;

	//Computation of r4+r7 in register r8
	ac_fixed<21,5,true,AC_TRN> r8 = r4 + r7;
	...
	ac_fixed<21,5,true,AC_TRN> r11 = r9 + r10;
	...
	ac_fixed<21,5,true,AC_TRN> r13 = r11 + r12;
	...
	ac_fixed<21,5,true,AC_TRN> r15 = r13 + r14;

	//Computation of r8+r15 in register r16
	ac_fixed<21,5,true,AC_TRN> r16 = r8 + r15;
