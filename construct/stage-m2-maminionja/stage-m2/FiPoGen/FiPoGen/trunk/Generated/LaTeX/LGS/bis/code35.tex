...
child{[sibling distance=3.000000cm]
	node(DAdd_3901497) [form] {$F$}
	child{
		node(Add_3901497) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt175k1 lsb  7_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt175k1 lsb  7) [mult] {$\times$}
			child{
				node(Cst0) [cst] {337781}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultu1k lsb  7_M) [decM] {$\gg 12 $}
		child{[level distance=0.4cm]
