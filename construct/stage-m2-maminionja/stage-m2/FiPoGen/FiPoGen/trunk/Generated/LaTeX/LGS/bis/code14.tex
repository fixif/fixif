...
child{[sibling distance=3.000000cm]
	node(DAdd_3901458) [form] {$F$}
	child{
		node(Add_3901458) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt111k1 lsb  9_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt111k1 lsb  9) [mult] {$\times$}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt112k1 lsb  9_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt112k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-387645}
