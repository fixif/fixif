...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt167k1 lsb  10_M) [decM] {$\gg 7 $}
			child{[level distance=0.4cm]
				node(Multt167k1 lsb  10) [mult] {$\times$}
				child{
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt168k1 lsb  10_M) [decM] {$\gg 5 $}
			child{[level distance=0.4cm]
				node(Multt168k1 lsb  10) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-2273264}
