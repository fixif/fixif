...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm]
		node(DMultt112k1 lsb  21) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt112k1 lsb  21) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-24228}
			edge from parent node[left] {(1,-14)}
			}
			child{
				node(Var1) [var] {$t112[k+1]$}
			edge from parent node[right] {(8,-7)}
			}
			edge from parent node[left] {(10,-21)}
		}
		edge from parent node[left,sloped,above] {(9,-22)}
	}
	child{[sibling distance=1cm]
		node(DMultt111k1 lsb  20) [form] {$F$}
		child{[level distance=0.4cm]
			node(Multt111k1 lsb  20) [mult] {$\times$}
			child{
				node(Cst0) [cst] {-32768}
			edge from parent node[left] {(0,-15)}
			}
			child{
				node(Var0) [var] {$t111[k+1]$}
		...
		edge from parent node[right] {(9,-22)}	}
