...
child{[sibling distance=3.000000cm]
	node(DAdd_3901463) [form] {$F$}
	child{
		node(Add_3901463) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt146k1 lsb  9_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt146k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {-2097152}
			edge from parent node[left] {(0,-21)}
			}
			child{
				node(Var0) [var] {$t146[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt147k1 lsb  9_M) [decM] {$\gg 19 $}
		child{[level distance=0.4cm]
			node(Multt147k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-361036}
			edge from parent node[left] {(-1,-20)}
			}
			child{
				node(Var1) [var] {$t147[k+1]$}
