...
child{[sibling distance=3.000000cm]
	node(DAdd_3901459) [form] {$F$}
	child{
		node(Add_3901459) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt118k1 lsb  9_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt118k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {-2097152}
			edge from parent node[left] {(0,-21)}
			}
			child{
				node(Var0) [var] {$t118[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt119k1 lsb  9_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt119k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-440235}
			edge from parent node[left] {(0,-19)}
			}
			child{
				node(Var1) [var] {$t119[k+1]$}
