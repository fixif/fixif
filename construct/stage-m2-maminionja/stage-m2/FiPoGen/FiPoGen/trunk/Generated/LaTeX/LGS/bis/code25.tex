...
child{[sibling distance=4.000000cm]
	node(DAdd_3901481) [form] {$F$}
	child{
		node(Add_3901481) [adder] {$+$}
	child{[sibling distance=3.000000cm]
		node(Add_3901480) [adder] {$+$}
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt165k1 lsb  9_M) [decM] {$\gg 6 $}
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt166k1 lsb  9_M) [decM] {$\gg 5 $}
			child{[level distance=0.4cm]
				node(Multt166k1 lsb  9) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-680362}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt164k1 lsb  9_M) [decM] {$\gg 5 $}
		child{[level distance=0.4cm]
			node(Multt164k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {507445}
