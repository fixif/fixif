...
child{[sibling distance=3.000000cm]
	node(DAdd_3901462) [form] {$F$}
	child{
		node(Add_3901462) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt139k1 lsb  9_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt139k1 lsb  9) [mult] {$\times$}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt140k1 lsb  9_M) [decM] {$\gg 19 $}
		child{[level distance=0.4cm]
			node(Multt140k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-388092}
