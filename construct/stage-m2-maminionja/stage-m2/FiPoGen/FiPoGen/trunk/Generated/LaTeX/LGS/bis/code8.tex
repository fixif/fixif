...
child{[sibling distance=3.000000cm]
	node(DAdd_3901455) [form] {$F$}
	child{
		node(Add_3901455) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt61k1 lsb  7_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt61k1 lsb  7) [mult] {$\times$}
			child{
				node(Cst0) [cst] {170091}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt62k1 lsb  7_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt62k1 lsb  7) [mult] {$\times$}
			child{
