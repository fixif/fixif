...
child{[sibling distance=3.000000cm]
	node(DAdd_3901495) [form] {$F$}
	child{
		node(Add_3901495) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt173k1 lsb  8_M) [decM] {$\gg 20 $}
		child{[level distance=0.4cm]
			node(Multt173k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {611876}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultu1k lsb  8_M) [decM] {$\gg 11 $}
		child{[level distance=0.4cm]
