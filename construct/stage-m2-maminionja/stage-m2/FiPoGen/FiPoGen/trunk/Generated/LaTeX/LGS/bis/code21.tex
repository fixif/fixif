...
child{[sibling distance=3.000000cm]
	node(DAdd_3901465) [form] {$F$}
	child{
		node(Add_3901465) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt161k1 lsb  10_M) [decM] {$\gg 22 $}
		child{[level distance=0.4cm]
			node(Multt161k1 lsb  10) [mult] {$\times$}
			child{
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt162k1 lsb  10_M) [decM] {$\gg 5 $}
		child{[level distance=0.4cm]
			node(Multt162k1 lsb  10) [mult] {$\times$}
			child{
