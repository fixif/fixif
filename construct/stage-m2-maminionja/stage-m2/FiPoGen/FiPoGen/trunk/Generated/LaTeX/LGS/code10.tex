...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt78k1 lsb  8_M) [decM] {$\gg 21 $}
		child{[level distance=0.4cm]
			node(Multt78k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst0) [cst] {1079782}
			edge from parent node[left] {(2,-19)}
			}
			child{
				node(Var0) [var] {$t78[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt79k1 lsb  8_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt79k1 lsb  8) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-1048576}
			edge from parent node[left] {(0,-20)}
			}
			child{
				node(Var1) [var] {$t79[k+1]$}
