...
child{[sibling distance=5.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultx4k lsb  10_M) [decM] {$\gg 19 $}
			child{[level distance=0.4cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			...
			child{[level distance=0.4cm]
				...
				child{
					node(Cst0) [cst] {204290}
				edge from parent node[left] {(-6,-24)}
				}
				child{
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt5k1 lsb  10_M) [decM] {$\gg 18 $}
			child{[level distance=0.4cm]
				node(Multt5k1 lsb  10) [mult] {$\times$}
				child{
					node(Cst3) [cst] {2097152}
				edge from parent node[left] {(1,-21)}
				}
				child{
					node(Var3) [var] {$t5[k+1]$}
