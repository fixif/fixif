...
child{[sibling distance=4.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt167k1 lsb  9_M) [decM] {$\gg 5 $}
			child{[level distance=0.4cm]
				node(Multt167k1 lsb  9) [mult] {$\times$}
				child{
					node(Cst2) [cst] {-594291}
				edge from parent node[left] {(1,-19)}
				}
				child{
					node(Var2) [var] {$t167[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt165k1 lsb  9_M) [decM] {$\gg 5 $}
		child{[level distance=0.4cm]
			node(Multt165k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {680362}
			edge from parent node[left] {(0,-20)}
			}
			child{
				node(Var0) [var] {$t165[k+1]$}
			edge from parent node[right] {(10,6)}
			}
		}
		edge from parent node[right,sloped,above] {(10,-9)}
