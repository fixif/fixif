...
child{[sibling distance=4.000000cm]
	node(DAdd_3901473) [form] {$F$}
	child{
		node(Add_3901473) [adder] {$+$}
	child{[sibling distance=3.000000cm]
		node(Add_3901472) [adder] {$+$}
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt163k1 lsb  9_M) [decM] {$\gg 6 $}
		...
		child{[sibling distance=1cm, level distance=0cm]
			...
			child{[level distance=0.4cm]
				...
				child{
					node(Cst2) [cst] {-434440}
				edge from parent node[left] {(-1,-20)}
				}
				child{
					node(Var2) [var] {$t164[k+1]$}
				edge from parent node[right] {(10,6)}
				}
			}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt162k1 lsb  9_M) [decM] {$\gg 5 $}
		child{[level distance=0.4cm]
			node(Multt162k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {363702}
			edge from parent node[left] {(-1,-20)}
			}
			child{
				node(Var0) [var] {$t162[k+1]$}
			edge from parent node[right] {(10,6)}
			}
		}
		edge from parent node[right,sloped,above] {(10,-9)}
