...
child{[sibling distance=3.000000cm]
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt61k1 lsb  9_M) [decM] {$\gg 20 $}
		child{[level distance=0.4cm]
			node(Multt61k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst0) [cst] {1418148}
			edge from parent node[left] {(1,-20)}
			}
			child{
				node(Var0) [var] {$t61[k+1]$}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt62k1 lsb  9_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt62k1 lsb  9) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-2097152}
			edge from parent node[left] {(0,-21)}
			}
			child{
				node(Var1) [var] {$t62[k+1]$}
