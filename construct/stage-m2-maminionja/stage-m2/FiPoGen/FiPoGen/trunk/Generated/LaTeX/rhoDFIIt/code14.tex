...
child{[sibling distance=5.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultu1k lsb  4_M) [decM] {$\gg 18 $}
			child{[level distance=0.4cm]
				node(Multu1k lsb  4) [mult] {$\times$}
				child{
					node(Cst1) [cst] {7985}
				edge from parent node[left] {(0,-13)}
				}
				child{
					node(Var1) [var] {$u1[k]$}
			...
			edge from parent node[left,sloped,above] {(8,-4)}
		}
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultx7k lsb  4_M) [decM] {$\gg 12 $}
			child{[level distance=0.4cm]
				node(Multx7k lsb  4) [mult] {$\times$}
				child{
					node(Cst2) [cst] {429}
				edge from parent node[left] {(-5,-14)}
				}
				child{
					node(Var2) [var] {$x7[k]$}
			...
			edge from parent node[right,sloped,above] {(8,-4)}
		}
		edge from parent node[left,sloped,above] {(8,-4)}
	}
	child{[sibling distance=3.000000cm]
		node(Add_112) [adder] {$+$}
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt1k1 lsb  4_M) [decM] {$\gg 20 $}
			child{[level distance=0.4cm]
				node(Multt1k1 lsb  4) [mult] {$\times$}
				child{
					node(Cst0) [cst] {-1632}
				edge from parent node[left] {(-7,-18)}
				}
				child{
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt8k1 lsb  4_M) [decM] {$\gg 11 $}
			child{[level distance=0.4cm]
				node(Multt8k1 lsb  4) [mult] {$\times$}
				child{
					node(Cst3) [cst] {8192}
				edge from parent node[left] {(1,-13)}
				}
				child{
					node(Var3) [var] {$t8[k+1]$}
