...
child{[sibling distance=3.000000cm]
	node(DAdd_3901456) [form] {$F$}
	child{
		node(Add_3901456) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt78k1 lsb  7_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt78k1 lsb  7) [mult] {$\times$}
			child{
				node(Cst0) [cst] {297146}
	...
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt79k1 lsb  7_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt79k1 lsb  7) [mult] {$\times$}
			child{
