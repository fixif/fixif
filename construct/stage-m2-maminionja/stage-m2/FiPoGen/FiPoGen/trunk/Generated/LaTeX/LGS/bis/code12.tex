...
child{[sibling distance=3.000000cm]
	node(DAdd_3901457) [form] {$F$}
	child{
		node(Add_3901457) [adder] {$+$}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt95k1 lsb  6_M) [decM] {$\gg 18 $}
		child{[level distance=0.4cm]
			node(Multt95k1 lsb  6) [mult] {$\times$}
			child{
				node(Cst0) [cst] {378302}
			edge from parent node[left] {(2,-17)}
			}
			child{
				node(Var0) [var] {$t95[k+1]$}
			edge from parent node[right] {(10,-7)}
			}
		}
		edge from parent node[left,sloped,above] {(11,-6)}
	}
	child{[sibling distance=1cm, level distance=0cm]
		node(DMultt96k1 lsb  6_M) [decM] {$\gg 6 $}
		child{[level distance=0.4cm]
			node(Multt96k1 lsb  6) [mult] {$\times$}
			child{
				node(Cst1) [cst] {-262144}
			edge from parent node[left] {(0,-18)}
			}
			child{
				node(Var1) [var] {$t96[k+1]$}
			edge from parent node[right] {(10,6)}
			}
		}
		edge from parent node[right,sloped,above] {(11,-6)}
	}
