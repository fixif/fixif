...
child{[sibling distance=5.000000cm]
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultt3k1 lsb  8_M) [decM] {$\gg 20 $}
			child{[level distance=0.4cm]
				node(Multt3k1 lsb  8) [mult] {$\times$}
				child{
					node(Cst1) [cst] {1235776}
				edge from parent node[left] {(-1,-22)}
				}
				child{
					node(Var1) [var] {$t3[k+1]$}
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultx2k lsb  8_M) [decM] {$\gg 16 $}
			child{[level distance=0.4cm]
				node(Multx2k lsb  8) [mult] {$\times$}
				child{
					node(Cst2) [cst] {262144}
	...
	child{[sibling distance=3.000000cm]
		...
		child{[sibling distance=1cm, level distance=0cm]
			node(DMultu1k lsb  8_M) [decM] {$\gg 16 $}
			child{[level distance=0.4cm]
				node(Multu1k lsb  8) [mult] {$\times$}
				child{
					node(Cst3) [cst] {162}
				edge from parent node[left] {(-9,-17)}
				}
				child{
					node(Var3) [var] {$u1[k]$}
