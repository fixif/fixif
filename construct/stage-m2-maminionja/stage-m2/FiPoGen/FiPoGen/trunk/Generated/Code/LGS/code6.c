...
double SoP_float(double v0,double v1)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.78519535064697265625 * v0 + -1 * v1;
	return r; 
}
...
ac_fixed<20,12,true> SoP_ac_fixed(ac_fixed<20,11,true,AC_TRN> v0,ac_fixed<5,11,true,AC_TRN> v1)
{
	...
	ac_fixed<21,1,true,AC_TRN> c0 = 0.78519535064697265625;
	sd = sd + c0*v0;
