...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.074153900146484375 * v8 + 1.17486572265625 * v5 + 0.5814208984375 * v2 + 1.44873046875 * v1 + 1.26123046875 * v3 + 0.913726806640625 * v0 + 0.752044677734375 * v7 + 0.932952880859375 * v6 + 0.4290008544921875 * v4;
	return r; 
}
...
ac_fixed<16,9,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v8,ac_fixed<16,9,true,AC_TRN> v5,ac_fixed<16,10,true,AC_TRN> v2,ac_fixed<16,9,true,AC_TRN> v1,ac_fixed<16,8,true,AC_TRN> v3,ac_fixed<16,9,true,AC_TRN> v0,ac_fixed<16,8,true,AC_TRN> v7,ac_fixed<16,8,true,AC_TRN> v6,ac_fixed<16,9,true,AC_TRN> v4)
{
	...
	ac_fixed<16,-2,true,AC_TRN> c8 = 0.074153900146484375;
	ac_fixed<32,7,true,AC_TRN> r0 = c8*v8;

	//Computation of c5*v5 in register r1
	ac_fixed<16,2,true,AC_TRN> c5 = 1.17486572265625;
	...
	ac_fixed<16,1,true,AC_TRN> c2 = 0.5814208984375;
	...
	ac_fixed<16,2,true,AC_TRN> c1 = 1.44873046875;
	...
	ac_fixed<16,2,true,AC_TRN> c3 = 1.26123046875;
	...
	ac_fixed<16,1,true,AC_TRN> c0 = 0.913726806640625;
	...
	ac_fixed<16,1,true,AC_TRN> c7 = 0.752044677734375;
	...
	ac_fixed<16,1,true,AC_TRN> c6 = 0.932952880859375;
	ac_fixed<32,9,true,AC_TRN> r13 = c6*v6;


	//Computation of r12+r13 in register r14
	ac_fixed<32,9,true,AC_TRN> r14 = r12 + r13;
	//Computation of c4*v4 in register r15
	ac_fixed<16,0,true,AC_TRN> c4 = 0.4290008544921875;
	ac_fixed<32,9,true,AC_TRN> r15 = c4*v4;
