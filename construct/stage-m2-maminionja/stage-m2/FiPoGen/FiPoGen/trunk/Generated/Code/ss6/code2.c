...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.06259822845458984375 * v0 + 0.419086933135986328125 * v1 + -0.086551189422607421875 * v2 + -0.1252803802490234375 * v3 + -0.0394496917724609375 * v4 + -0.516998291015625 * v5 + 0.4429798126220703125 * v6 + -0.048481464385986328125 * v7 + -0.1715984344482421875 * v8;
	return r; 
}
...
ac_fixed<17,10,true> SoP_ac_fixed(ac_fixed<18,9,true,AC_TRN> v0,ac_fixed<19,10,true,AC_TRN> v1,ac_fixed<17,10,true,AC_TRN> v2,ac_fixed<18,9,true,AC_TRN> v3,ac_fixed<19,9,true,AC_TRN> v4,ac_fixed<19,10,true,AC_TRN> v5,ac_fixed<18,9,true,AC_TRN> v6,ac_fixed<18,10,true,AC_TRN> v7,ac_fixed<17,9,true,AC_TRN> v8)
{
