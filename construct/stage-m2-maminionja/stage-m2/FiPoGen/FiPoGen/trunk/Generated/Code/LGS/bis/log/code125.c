...
ac_fixed<16,11,true> SoP_ac_fixed(ac_fixed<16,10,true,AC_TRN> v1,ac_fixed<16,11,true,AC_TRN> v0)
{
	...
	ac_fixed<16,1,true,AC_TRN> c1 = -0.839691162109375;
