...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.94012451171875 * v8 + 10.5361328125 * v1 + 9.55078125 * v0 + 10.6513671875 * v7 + 6.982666015625 * v5 + 11.2001953125 * v3 + 2.7647705078125 * v2 + 4.471923828125 * v6 + 2.360107421875 * v4;
	return r; 
}
...
ac_fixed<16,12,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v8,ac_fixed<16,9,true,AC_TRN> v1,ac_fixed<16,9,true,AC_TRN> v0,ac_fixed<16,8,true,AC_TRN> v7,ac_fixed<16,9,true,AC_TRN> v5,ac_fixed<16,8,true,AC_TRN> v3,ac_fixed<16,10,true,AC_TRN> v2,ac_fixed<16,8,true,AC_TRN> v6,ac_fixed<16,9,true,AC_TRN> v4)
{
	...
	ac_fixed<16,5,true,AC_TRN> c3 = 11.2001953125;
	ac_fixed<32,13,true,AC_TRN> r9 = c3*v3;


	//Computation of r8+r9 in register r10
	ac_fixed<32,12,true,AC_TRN> r10 = r8 + r9;
	//Computation of c2*v2 in register r11
	ac_fixed<16,3,true,AC_TRN> c2 = 2.7647705078125;
	...
	ac_fixed<16,4,true,AC_TRN> c6 = 4.471923828125;
	...
	ac_fixed<16,3,true,AC_TRN> c4 = 2.360107421875;
	ac_fixed<32,12,true,AC_TRN> r15 = c4*v4;
