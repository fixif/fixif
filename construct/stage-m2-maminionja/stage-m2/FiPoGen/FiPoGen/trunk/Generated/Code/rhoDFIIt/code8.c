...
/* double SoP_ac_fixed(float tab[int16_t v0,int16_t v1,int16_t v2,int16_t v3])
{
	...
	ac_fixed<21,11,true,AC_TRN> r0 = c1*v1;


	//Computation of c2*v2 in register r1
	ac_fixed<23,2,true,AC_TRN> c2 = 1.037916660308837890625;
	...
	ac_fixed<23,-1,true,AC_TRN> c0 = -0.21370983123779296875;
	ac_fixed<20,14,true,AC_TRN> v0 = L0;
	ac_fixed<21,11,true,AC_TRN> r3 = c0*v0;


	//Computation of c3*v3 in register r4
	ac_fixed<20,1,true,AC_TRN> c3 = -0.6292400360107421875;
	ac_fixed<18,9,true,AC_TRN> v3 = L3;
	ac_fixed<19,9,true,AC_TRN> r4 = c3*v3;
