...
double SoP_float(double v0,double v1)
{
    /*      TP_Float_sop        */
    double r;
    r = 1.327266693115234375 * v0 + -0.94012451171875 * v1;
	return r; 
}
...
ac_fixed<17,12,true> SoP_ac_fixed(ac_fixed<18,12,true,AC_TRN> v0,ac_fixed<16,9,true,AC_TRN> v1)
{
	...
	ac_fixed<20,2,true,AC_TRN> c0 = 1.327266693115234375;
	sd = sd + c0*v0;
