...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 4.193878173828125 * v0 + -7.44347381591796875 * v1 + -0.1221771240234375 * v2 + -3.9579010009765625 * v3 + 2.1352081298828125 * v4 + 8.22547149658203125 * v5 + -5.5097503662109375 * v6 + 3.78228759765625 * v7 + -0.11029052734375 * v8;
	return r; 
}
...
ac_fixed<17,14,true> SoP_ac_fixed(ac_fixed<18,9,true,AC_TRN> v0,ac_fixed<19,10,true,AC_TRN> v1,ac_fixed<17,10,true,AC_TRN> v2,ac_fixed<18,9,true,AC_TRN> v3,ac_fixed<19,9,true,AC_TRN> v4,ac_fixed<19,10,true,AC_TRN> v5,ac_fixed<18,9,true,AC_TRN> v6,ac_fixed<18,10,true,AC_TRN> v7,ac_fixed<17,9,true,AC_TRN> v8)
{
