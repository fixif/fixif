...
double SoP_float(double v0,double v1,double v2)
{
    /*      TP_Float_sop        */
    double r;
    r = -1 * v1 + -1.133544921875 * v2 + 0.648834228515625 * v0;
	return r; 
}
...
ac_fixed<16,11,true> SoP_ac_fixed(ac_fixed<16,11,true,AC_TRN> v1,ac_fixed<16,10,true,AC_TRN> v2,ac_fixed<16,11,true,AC_TRN> v0)
{
	...
	ac_fixed<16,2,true,AC_TRN> c2 = -1.133544921875;
	...
	ac_fixed<16,1,true,AC_TRN> c0 = 0.648834228515625;
