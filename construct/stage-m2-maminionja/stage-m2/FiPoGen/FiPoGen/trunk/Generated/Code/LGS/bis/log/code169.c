...
double SoP_float(double v0,double v1,double v2)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.3468475341796875 * v2 + -1 * v1 + 0.0859375 * v0;
	return r; 
}
...
ac_fixed<16,11,true> SoP_ac_fixed(ac_fixed<16,11,true,AC_TRN> v2,ac_fixed<16,11,true,AC_TRN> v1,ac_fixed<16,12,true,AC_TRN> v0)
{
	...
	ac_fixed<16,0,true,AC_TRN> c2 = -0.3468475341796875;
	...
	ac_fixed<16,-2,true,AC_TRN> c0 = 0.0859375;
	ac_fixed<32,10,true,AC_TRN> r3 = c0*v0;
