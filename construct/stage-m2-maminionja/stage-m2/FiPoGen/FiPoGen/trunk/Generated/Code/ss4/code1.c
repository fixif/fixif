...
double SoP_float(double v0,double v1,double v2,double v3,double v4,double v5,double v6,double v7,double v8)
{
    /*      TP_Float_sop        */
    double r;
    r = 0.4317538738250732421875 * v0 + 0.245232105255126953125 * v1 + 0.146778583526611328125 * v2 + 1.29412519931793212890625 * v3 + 0.460979461669921875 * v4 + -0.0702617168426513671875 * v5 + 0.1080167293548583984375 * v6 + 0.289010584354400634765625 * v7 + 0.606799602508544921875 * v8;
	return r; 
}
