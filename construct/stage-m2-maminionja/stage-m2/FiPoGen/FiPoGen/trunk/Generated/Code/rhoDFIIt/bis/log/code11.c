...
double SoP_float(double v0,double v1,double v2,double v3)
{
    /*      TP_Float_sop        */
    double r;
    r = -0.069732666015625 * v3 + 0.2017822265625 * v2 + 1 * v1 + 0.2574462890625 * v0;
	return r; 
}
...
ac_fixed<16,12,true> SoP_ac_fixed(ac_fixed<16,9,true,AC_TRN> v3,ac_fixed<16,12,true,AC_TRN> v2,ac_fixed<16,11,true,AC_TRN> v1,ac_fixed<16,12,true,AC_TRN> v0)
{
	...
	ac_fixed<16,-2,true,AC_TRN> c3 = -0.069732666015625;
	ac_fixed<32,7,true,AC_TRN> r0 = c3*v3;

	//Computation of c2*v2 in register r1
	ac_fixed<16,-1,true,AC_TRN> c2 = 0.2017822265625;
	...
	ac_fixed<16,0,true,AC_TRN> c0 = 0.2574462890625;
