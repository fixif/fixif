...
#fonction : construire d'une matrice de taille a,b 
def mat(a,b):
...
for b in lallblocks:
	if getblocktype(b[0],lallblocks) == 'Sum':
		if b[0] <> binter: # la variable temporaire supprime ------------------
			t.append(b[0])
