...
def CheckGabaritForQuantizedRealizations(g, q):
	"""
	Given the gabarit object g and quantization factor q,
	this function checks whether the State-Space realization of
	the Butterworth filter (generated by MATLAB) whose [Stae-Space's]
	coefficients were further quantized to q bits verifies the
