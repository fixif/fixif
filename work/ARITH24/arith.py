...
try:
	(ans, margin) = CheckIfRealizationInGabarit(g, R)
	print ('\n\n-------> Gabarit check with State-Space realization quantized to %d bits checks %s with dBmargin=%e' % (q, ans, margin))
except ValueError as e:
	print ('\n\n-------> Could not check the gabarit: %s') % e
