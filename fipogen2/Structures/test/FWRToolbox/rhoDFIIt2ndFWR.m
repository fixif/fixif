...
%
%Syntax:
% [R1, R2 flag] = rhoDFIIt2ndFWR( num, den, gamma, isGammaExact, delta, isDeltaExact)
%
%Parameters:
...
%
%
% $Id: rhoDFIIt2FWR.m 254 2010-07-01 09:14:05Z hilaire $


function [R1,R2, flag] = rhoDFIIt2ndFWR( num, den, gamma, isGammaExact, delta, isDeltaExact)
...
Wc = gram_int( Abar, Bbar,Cbar, Dbar, 'c');
