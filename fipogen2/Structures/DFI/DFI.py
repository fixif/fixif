...
class DFI(SIF):
    ...
    # ???    
        ...
        if opt is 1:
            ...
            gamma4 = r_[zeros((nnum, 2)), atleast_2d([1,1]), zeros((nden-1, 2))]
        ...
        if opt is 1:
            ...
            JtoS = den[0,0], invT*gamma4, atleast_2d(1), gamma1*T, atleast_2d(num[0,0]), invT*gamma2*T, invT*gamma3, mat(zeros((1, nnum+nden))), atleast_2d(0)
        
        elif opt is 2:
        	
        	JtoS = mat(eye(2)), invT*gamma4, mat([1,1]), gamma1*T, r_[[num[0,0]],[0]], invT*gamma2*T, invT*gamma3, mat(zeros((1,nnum+nden))), atleast_2d(0)
        # define event
