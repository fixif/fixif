%Purpose:
% Write the C code corresponding to a fixed-point scalar product
% (the vector of coefficient 'P' by the vector of variables 'name').
% Ex: P(1)*name(1) + P(2)*name(2) + ... + P(n)*name(n)
%
%Syntax:
% scalprodCint( fiel, P, name, gamma, shift, strAcc)
%
%Parameters:
...
function scalprodCint( file, P, name, gamma, shift, strAcc)
